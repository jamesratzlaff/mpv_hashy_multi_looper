...
export class MetaObj {
    ...
    constructor(filepath?:string,duration?:number){
        ...
        this._duration=duration!==undefined?duration:mp.get_time_ms()*1000;
    ...
    public toJSON(){
        return {"hash":this.hash,"duration":this.duration,"clips":this.clips,"description_tags":this._description_tags};
    }
